...
void add_value_to_shadow_register(uint32_t value, uint32_t selected_register){

	reg_la0_data = (selected_register << 5| 14 & 0x1F);
	reg_la1_data = value;
}

void read_value_from_shadow_register(uint32_t selected_register){

	reg_la0_data = (selected_register << 5| 13 & 0x1F);
...
void main()
{
	...
	reg_la2_data = 0x00000000;
	// end clock
	add_value_to_shadow_register(1,0);
	clock();
	add_value_to_shadow_register(255,1);
	clock();
	// add error
	add_value_to_register(23,17);
	clock();
	// check values
	read_value_from_shadow_register(1);
	clock();
	read_value_from_shadow_register(0);
	clock();
